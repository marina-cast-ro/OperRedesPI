...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Captura de sensor de movimiento y envio periodico"
    )
    ...
    parser.add_argument(
        "--file",
        default="message.txt",
        help="Ruta del archivo de datos (default: message.txt)",
    )
    parser.add_argument(
        "--binary", default="../user/build/server", help="Ruta al binario compilado"
    )
    parser.add_argument(
        "--interval",
        type=int,
        default=30,
        help="Intervalo de envio en segundos (default: 30)",
    )
